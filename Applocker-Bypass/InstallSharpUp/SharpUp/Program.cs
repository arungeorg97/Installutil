...
namespace SharpUp
{
    ...
    {
        public static bool auditMode = false;
        ...
        public static Type[] GetAvailableChecks()
        {
        ...
        public static Type[] GetChecksFromArgumentString(string[] args)
        {
...
";
    ...
    public class SharpUp : System.Configuration.Install.Installer
    {
